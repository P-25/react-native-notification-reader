...
const PACKAGE_DEST_PATH = path.resolve(
    __dirname,
    'node_modules/react-native-android-notification-listener'
)
...
;(async () => {
    try {
        ...
        await executeAsync(
            `cp -f ${PACKAGE_PATH}/index.js ${PACKAGE_DEST_PATH}/index.js`
        )
        await executeAsync(
            `cp -f ${PACKAGE_PATH}/index.d.ts ${PACKAGE_DEST_PATH}/index.d.ts`
        )
        await executeAsync(
